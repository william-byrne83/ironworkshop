...
define('CACHE_DIR_NAME',		'/assets/images/image_cache/');
define('CACHE_DIR',				DOCUMENT_ROOT . CACHE_DIR_NAME);
...
if ($tnWidth <= 211) {
	/*$watermark = imagecreatefrompng($docRoot.'/assets/images/watermark_xsmall.png');
	$watermark_pos_x = $tnWidth - imagesx($watermark) - 10;
	$watermark_pos_y = $tnHeight - imagesy($watermark) - 10;*/
}elseif ($tnWidth <= 270) {
	/*$watermark = imagecreatefrompng($docRoot.'/assets/images/watermark_small.png');
	$watermark_pos_x = $tnWidth - imagesx($watermark) - 10;
	$watermark_pos_y = $tnHeight - imagesy($watermark) - 10;*/
} else {
   	$watermark = imagecreatefrompng($docRoot.'/assets/images/watermark_medium.png');
	$watermark_pos_x = $tnWidth - imagesx($watermark) - 30;
	$watermark_pos_y = $tnHeight - imagesy($watermark) - 30;
}

// merge the source image and the watermark
if(!empty($watermark)){
	imagecopy($dst, $watermark,  $watermark_pos_x, $watermark_pos_y, 0, 0, imagesx($watermark), imagesy($watermark));
}
