<?php
class TrainerImagesBackoffice extends Model{
	/** __construct */
	 ...
	 * This function gets trainer_images information for backoffice
	 * @param int $id
	 */
	public function selectDataByID($id){
		$sql = "SELECT t1.id, t1.trainer_id, t1.sort, t1.image, t1.title, t1.is_active
    ...
    /**
	 * FUNCTION: getAllData
	 * This function returns the details for All trainer_images
	...
	public function getAllData($limit = false, $keywords = false, $active = false, $id = false){
        ...
        $optTrainer = $id != false ? " AND t1.trainer_id = $id" : "";
	 ...
	 * This function returns the count for All trainer_images
	 * @param int $keywords
	 */
    ...
    /**
	 * FUNCTION: createData
	 * This function adds a new trainer_images to the Database from backoffice
	 * @param mixed $data Array of trainer_images Data
	 */
    ...
    /**
	 * FUNCTION: updateData
	 * This function updates trainer_images details for backoffice
    ...
    /**
	 * FUNCTION: deleteData
	 * This function deletes an trainer_images
	 * @param Int $id of an trainer_images
	 */
	 ...
	 * This function updates the trainer_images order field
    ...
    public function updateSortOrder($id, $order, $store_id){
        ...
        $where = "`id` = {$id} AND `trainer_id` = {$store_id}";
        $this->_db->update($dbTable, $postData, $where);
        return true;
    }
	 ...
	 * This function updates the trainer_images order field based on its order value
    ...
    public function updateOldSortOrder($direction = false, $order = false, $store_id){
        ...
        $dbTable = 'trainer_images';
        $where = "`sort` = {$order} AND `trainer_id` = {$store_id}";
        $this->_db->update($dbTable, $postData, $where);
        return true;
    }
