    	...
    	<div class="block-title">
            ...
            <div class="block-options pull-right">
	    		 <div id="esearch" class="dataTables_filter">
		    		<form class="form-wrap" method='get' action='/backoffice/categories/index'>
		        ...
		        <div class="row">
			       <div class="col-xs-12">
				        <div class="pull-right">
                            <a href="/backoffice/categories/add" class="btn btn-success"><i class="fa fa-plus"></i> Add Category</a>
                        </div>
					</div>
				</div>
                            ...
                            <tbody>
                                <?php foreach($this->getAllData as $data) {?>
                                    <tr <?php if($data['is_active'] == 0){ echo 'class="danger"'; } ?>>
                                        ...
                                        <td class="text-left">
                                            <a href="/backoffice/categories/edit/<?php echo $data['id']; ?>/" data-toggle="tooltip" title="Edit Category" class="btn btn-effect-ripple btn-sm btn-success"><i class="fa fa-pencil"></i></a>
                                            <a href="/backoffice/categories/delete/<?php echo $data['id']; ?>/" data-toggle="tooltip" title="Delete Category" class="btn btn-effect-ripple btn-sm btn-danger"><i class="fa fa-times"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
