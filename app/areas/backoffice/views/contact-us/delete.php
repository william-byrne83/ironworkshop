...
<div id="page-content">
    ...
    <div class="block">
        ...
        <div class="block-title">
            <h2>Delete '<?php echo $this->selectedData[0]['facebook']; ?>'</h2>
        </div>
        <!-- END General Elements Title -->
		<!-- General Elements Content -->
		<div class="alert alert-danger alert-dismissable">
	        <h4><strong>Warning</strong></h4>
	        <p>Please note that this will remove this Contacts. You can add them again at a later time.</p>
	    </div>
		<form action="" method="post" class="form-horizontal form-bordered">
        	<input type="hidden" name="id" value="<?php echo $this->selectedData[0]['id']; ?>" />
			<div class="form-group">
                <div class="col-md-9">
                    <p class="form-control-static">You are removing: <strong><?php echo $this->selectedData[0]['facebook']; ?></strong></p>
                </div>
            </div>
